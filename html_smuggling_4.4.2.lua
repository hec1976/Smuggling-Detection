...
--
-- v4.4.1
--   1. REASON_MODULE_MAP und DEFAULT_REASON_POLICY zu REASON_REGISTRY zusammengefuehrt.
--      Neuen Reason hinzufuegen = eine Stelle statt zwei.
--      Admin-Overrides via CFG.reason_policy bleiben voll erhalten (nur class/bonus_module).
--   2. apply_markers(): warnx fuer ungemappte payload_kind / critical_kind Werte.
--
-- v4.4.2
...
-- Jeder Eintrag hat:
--   module       = Modulname (frueher REASON_MODULE_MAP)
--   class        = Klasse    (frueher DEFAULT_REASON_POLICY.class)
--   bonus_module = optional  (frueher DEFAULT_REASON_POLICY.bonus_module)
-- =========================
local DEFAULT_REASON_REGISTRY = {
  ms_appinstaller_uri     = { module = "appinstaller",        class = "CRITICAL" },
  ms_appinstaller_word    = { module = "appinstaller",        class = "JS_SMUGGLING" },
  appinstaller_file       = { module = "appinstaller",        class = "JS_SMUGGLING" },
  dec_xml_appinstaller    = { module = "appinstaller",        class = "CRITICAL" },

  atob                    = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  blob                    = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  createObjectURL         = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  fetch                   = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  filereader              = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  uint8array              = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  split_payload           = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  delayed_execution       = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  timeout_b64_smuggling   = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  timeout_b64_decode      = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  timeout_b64             = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  dom_clobbering          = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  data_uri                = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  iframe_src              = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  b64_long_html           = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  b64_total_len_big       = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  b64_total_len_huge      = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  b64_joined_parts        = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  virtual_b64_candidates  = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  array_index_atob        = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  array_index_blob        = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  array_index_fetch       = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  settimeout_call         = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  setinterval_call        = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  event_handler_api       = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  computed_redirect       = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  dec_js                  = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  dec_html                = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  dec_pdf                 = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  dec_xml                 = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  dec_bin                 = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  webcrypto_api           = { module = "js_smuggling",        class = "SUSPICIOUS_API" },
  serviceworker_api       = { module = "js_smuggling",        class = "SUSPICIOUS_API" },
  webworker               = { module = "js_smuggling",        class = "SUSPICIOUS_API" },
  webassembly             = { module = "js_smuggling",        class = "SUSPICIOUS_API" },
  qr_canvas_api           = { module = "js_smuggling",        class = "SUSPICIOUS_API" },
  att_html_attachment     = { module = "js_smuggling",        class = "JS_SMUGGLING" },
  att_svg_smuggling_context = { module = "js_smuggling",      class = "JS_SMUGGLING" },
  att_svg_data_uri        = { module = "attachment_vectors",  class = "JS_SMUGGLING" },

  obfus_api               = { module = "obfuscation",        class = "OBFUSCATION" },
  atob_obfuscated         = { module = "obfuscation",        class = "OBFUSCATION" },
  hex_array               = { module = "obfuscation",        class = "OBFUSCATION" },
  array_join_concat       = { module = "obfuscation",        class = "OBFUSCATION" },
  bracket_atob            = { module = "obfuscation",        class = "OBFUSCATION" },
  fromcharcode_api        = { module = "obfuscation",        class = "OBFUSCATION" },
  fromcharcode_heavy      = { module = "obfuscation",        class = "OBFUSCATION" },
  function_constructor    = { module = "obfuscation",        class = "OBFUSCATION" },
  eval_call               = { module = "obfuscation",        class = "OBFUSCATION" },
  polymorphic_obfuscation = { module = "obfuscation",        class = "OBFUSCATION" },
  hex_var_names           = { module = "obfuscation",        class = "OBFUSCATION" },
  hex_vars                = { module = "obfuscation",        class = "OBFUSCATION" },
  very_high_entropy       = { module = "obfuscation",        class = "OBFUSCATION" },
  high_entropy            = { module = "obfuscation",        class = "OBFUSCATION" },
  array_string_storage    = { module = "obfuscation",        class = "OBFUSCATION" },
  array_storage           = { module = "obfuscation",        class = "OBFUSCATION" },
  func_obfuscation        = { module = "obfuscation",        class = "OBFUSCATION" },
  wasm_eval_bridge        = { module = "wasm_staging",       class = "OBFUSCATION" },
  blockchain_eval_bridge  = { module = "blockchain_staging", class = "OBFUSCATION" },
  css_code_execution      = { module = "css_code_execution", class = "OBFUSCATION" },
  css_computedstyle_exec  = { module = "css_code_execution", class = "OBFUSCATION" },
  css_hidden_code_string  = { module = "css_code_execution", class = "OBFUSCATION" },
  css_function_bridge     = { module = "css_code_execution", class = "OBFUSCATION" },
  rc4_ksa_pattern         = { module = "rc4_detection",      class = "OBFUSCATION" },
  rc4_prga_pattern        = { module = "rc4_detection",      class = "OBFUSCATION" },
  rc4_xor_loop            = { module = "rc4_detection",      class = "OBFUSCATION" },
  rc4_decrypt_call        = { module = "rc4_detection",      class = "OBFUSCATION" },
  rc4_key_material        = { module = "rc4_detection",      class = "OBFUSCATION" },

  dec_pe               = { module = "decoded_payload",   class = "CRITICAL" },
  dec_wasm             = { module = "decoded_payload",   class = "CRITICAL" },
  dec_msix             = { module = "decoded_payload",   class = "CRITICAL" },
  dec_appx             = { module = "decoded_payload",   class = "CRITICAL" },
  dec_zip              = { module = "decoded_payload",   class = "CONTAINER" },
  dec_iso              = { module = "decoded_payload",   class = "CONTAINER" },
  dec_lnk              = { module = "decoded_payload",   class = "CONTAINER" },
  dec_rar              = { module = "decoded_payload",   class = "CONTAINER" },
  dec_7zip             = { module = "decoded_payload",   class = "CONTAINER" },
  dec_cab              = { module = "decoded_payload",   class = "CONTAINER" },
  ...
  pdf_uint8array       = { module = "uint8array",        class = "JS_SMUGGLING" },
  pe_uint8array        = { module = "uint8array",        class = "CRITICAL" },
  wasm_uint8array      = { module = "uint8array",        class = "CRITICAL" },
  zip_uint8array       = { module = "uint8array",        class = "CONTAINER" },

  external_scripts     = { module = "external_scripts",  class = "BONUS_SOFT", bonus_module = "external_scripts" },

  css_exfiltration     = { module = "css_exfil",         class = "BONUS_SOFT", bonus_module = "css_exfil" },
  css_import_external  = { module = "css_exfil",         class = "BONUS_INFO" },
  css_attr_exfil       = { module = "css_exfil",         class = "BONUS_INFO" },
  css_large_b64        = { module = "css_exfil",         class = "BONUS_INFO" },

  geo_targeting_api    = { module = "geo_targeting",     class = "SUSPICIOUS_API" },
  geo_location_api     = { module = "geo_targeting",     class = "SUSPICIOUS_API" },
  timezone_targeting   = { module = "geo_targeting",     class = "BONUS_SOFT", bonus_module = "geo_targeting" },

  antisandbox_webdriver      = { module = "evasion",     class = "EVASION" },
  hardware_check_evasion     = { module = "evasion",     class = "EVASION" },
  human_interaction_required = { module = "evasion",     class = "EVASION" },

  localstorage_persistence   = { module = "persistence", class = "SUSPICIOUS_API" },
  sessionstorage_persistence = { module = "persistence", class = "SUSPICIOUS_API" },

  domain_rotation      = { module = "domain_rotation",   class = "BONUS_SOFT", bonus_module = "domain_rotation" },

  clickfix_lure        = { module = "clickfix",          class = "BONUS_SOFT", bonus_module = "clickfix" },
  fake_captcha_lure    = { module = "clickfix",          class = "BONUS_SOFT", bonus_module = "clickfix" },
  clipboard_exec_lure  = { module = "clickfix",          class = "BONUS_SOFT", bonus_module = "clickfix" },
  run_dialog_lure      = { module = "clickfix",          class = "BONUS_SOFT", bonus_module = "clickfix" },
  powershell_lure      = { module = "clickfix",          class = "BONUS_SOFT", bonus_module = "clickfix" },

  wasm_staged_payload     = { module = "wasm_staging",   class = "SUSPICIOUS_API" },
  wasm_fetch_stage        = { module = "wasm_staging",   class = "SUSPICIOUS_API" },
  wasm_inline_stage       = { module = "wasm_staging",   class = "SUSPICIOUS_API" },
  wasm_worker_stage       = { module = "wasm_staging",   class = "SUSPICIOUS_API" },
  wasm_suspicious_exports = { module = "wasm_staging",   class = "BONUS_SOFT", bonus_module = "wasm_staging" },

  blockchain_staged_payload = { module = "blockchain_staging", class = "SUSPICIOUS_API" },
  web3_api_usage            = { module = "blockchain_staging", class = "SUSPICIOUS_API" },
  ethers_contract_payload   = { module = "blockchain_staging", class = "SUSPICIOUS_API" },
  web3_eth_call             = { module = "blockchain_staging", class = "SUSPICIOUS_API" },
  blockchain_remote_stage   = { module = "blockchain_staging", class = "BONUS_SOFT", bonus_module = "blockchain_staging" },

  css_before_after_content  = { module = "css_code_execution", class = "BONUS_SOFT", bonus_module = "css_code_execution" },

  push_notification_flow    = { module = "push_abuse",   class = "BONUS_INFO" },
  push_permission_request   = { module = "push_abuse",   class = "BONUS_INFO" },
  push_serviceworker_combo  = { module = "push_abuse",   class = "BONUS_INFO" },

  att_pdf_javascript          = { module = "attachment_vectors", class = "SUSPICIOUS_API" },
  att_pdf_openaction          = { module = "attachment_vectors", class = "SUSPICIOUS_API" },
  att_pdf_launch              = { module = "attachment_vectors", class = "SCRIPT_HARD" },
  att_pdf_embeddedfile        = { module = "attachment_vectors", class = "CONTAINER" },
  att_pdf_richmedia           = { module = "attachment_vectors", class = "SUSPICIOUS_API" },
  att_svg_script              = { module = "attachment_vectors", class = "SCRIPT_HARD" },
  att_svg_event_handler       = { module = "attachment_vectors", class = "SUSPICIOUS_API" },
  att_svg_foreignobject       = { module = "attachment_vectors", class = "SUSPICIOUS_API" },
  att_svg_xlink_href          = { module = "attachment_vectors", class = "SUSPICIOUS_API" },
  att_chm_attachment          = { module = "attachment_vectors", class = "CONTAINER" },
  att_hta_attachment          = { module = "attachment_vectors", class = "SCRIPT_HARD" },
  att_onenote_attachment      = { module = "attachment_vectors", class = "CONTAINER" },
  ...
  cert_attachment_file        = { module = "certificate_smuggling", class = "BONUS_INFO" },
  cert_data_uri               = { module = "certificate_smuggling", class = "BONUS_SOFT", bonus_module = "certificate_smuggling" },
  cert_base64_block           = { module = "certificate_smuggling", class = "BONUS_SOFT", bonus_module = "certificate_smuggling" },

  image_polyglot_name         = { module = "image_smuggling_info", class = "BONUS_INFO" },
  image_embedded_payload_hint = { module = "image_smuggling_info", class = "BONUS_INFO" },
  image_double_ext            = { module = "image_smuggling_info", class = "BONUS_INFO" },

  script_time_budget            = { module = nil, class = "INFO" },
  script_total_budget           = { module = nil, class = "INFO" },
  deobfus_timeout               = { module = nil, class = "INFO" },
  decode_gate_not_strong_enough = { module = nil, class = "INFO" },
  decode_depth_limit            = { module = nil, class = "INFO" },
  soft_only_cap                 = { module = nil, class = "INFO" },
  max_final_score               = { module = nil, class = "INFO" },
  min_score                     = { module = nil, class = "INFO" },
  critical_boost                = { module = nil, class = "INFO" },
  single_sniff_pe               = { module = nil, class = "INFO" },
}
...
local function merge_module_config(defaults, overrides)
  ...
  for mod_name, mod_cfg in pairs(overrides) do
    if type(mod_name) == "string"
       and type(mod_cfg) == "table"
       and type(defaults[mod_name]) == "table" then
      for k, v in pairs(mod_cfg) do
        out[mod_name][k] = v
      end
    end
  end
...
-- Merged REASON_REGISTRY mit CFG-Overrides.
-- CFG.reason_policy darf nur die Policy-Felder class und bonus_module ueberschreiben,
-- nicht das Modul-Feld. Das entspricht dem alten Verhalten von merge_reason_policy():
-- Admins koennen eine Reason in eine andere Klasse verschieben oder einen Bonus-Modul
-- setzen, aber nicht den Modul-Zustaendigkeitsbereich aendern.
-- Unbekannte Felder in CFG.reason_policy werden stillschweigend ignoriert.
local function merge_reason_registry(defaults, overrides)
  ...
  for reason, policy in pairs(overrides) do
    if type(reason) == "string" and type(policy) == "table" then
      ...
      if policy.class ~= nil then out[reason].class = policy.class end
      if policy.bonus_module ~= nil then out[reason].bonus_module = policy.bonus_module end
    end
  end
  return out
end
...
local function get_effective_weight(module_name)
  ...
  if m and m.weight_override ~= nil then
...
local function validate_cfg_module_overrides(overrides, errs)
  if type(overrides) ~= "table" then
    return
  end

  for name, cfg in pairs(overrides) do
    if not VALID_MODULE_NAMES[name] then
      errs[#errs + 1] = "unbekanntes Modul in CFG.modules: " .. tostring(name)
    else
      validate_single_module(name, cfg, errs)
    end
  end
end

-- Validiert REASON_REGISTRY nach dem Merge mit CFG.reason_policy.
-- Prueft class gegen VALID_REASON_CLASSES, module und bonus_module gegen VALID_MODULE_NAMES.
-- Laeuft nach BASE_WEIGHT_MAP = get_base_weight_map() und nach Build von REASON_REGISTRY.
local function validate_reason_registry(registry, errs)
  for reason, entry in pairs(registry or {}) do
    if type(reason) ~= "string" then
      errs[#errs + 1] = "reason_registry hat nicht-string key"
    elseif type(entry) ~= "table" then
      errs[#errs + 1] = "reason_registry." .. tostring(reason) .. " ist kein table"
    else
      if entry.class ~= nil and not VALID_REASON_CLASSES[entry.class] then
        errs[#errs + 1] = "reason_registry." .. reason .. ".class ist ungueltig: " .. tostring(entry.class)
      end
      if entry.module ~= nil and not VALID_MODULE_NAMES[entry.module] then
        errs[#errs + 1] = "reason_registry." .. reason .. ".module ist unbekannt: " .. tostring(entry.module)
      end
      if entry.bonus_module ~= nil
         and BASE_WEIGHT_MAP[entry.bonus_module] == nil
         and not VALID_MODULE_NAMES[entry.bonus_module] then
        errs[#errs + 1] = "reason_registry." .. reason .. ".bonus_module ist unbekannt: " .. tostring(entry.bonus_module)
      end
    end
  end
end
  ...
  if STRICT_WEIGHT_VALIDATION then
    for k, v in pairs(W or {}) do
      if tonumber(v) == nil then
        add_err("weight " .. tostring(k) .. " ist nicht numerisch")
      elseif tonumber(v) < 0 then
        add_err("weight " .. tostring(k) .. " ist negativ")
      elseif tonumber(v) > 50 then
        add_err("weight " .. tostring(k) .. " ist unrealistisch hoch")
      end
    end
  end

  validate_cfg_module_overrides(CFG.modules, errs)

  for name, cfg in pairs(MODULES or {}) do
    if not VALID_MODULE_NAMES[name] then
      add_err("unbekanntes Modul: " .. tostring(name))
    else
      validate_single_module(name, cfg, errs)
    end
  end
...
-- get_reason_policy() liest jetzt aus REASON_REGISTRY statt REASON_POLICY.
-- Rueckgabe-Format identisch zu vorher: { class = "...", bonus_module = "..." }
local function get_reason_policy(why)
  if not why or why == "" then return { class = "JS_SMUGGLING" } end
  local entry = REASON_REGISTRY[why]
  if type(entry) == "table" then
    return { class = entry.class or "JS_SMUGGLING", bonus_module = entry.bonus_module }
  end
  -- Fallback-Heuristiken unveraendert aus v4.4.0
...
-- get_reason_module() ersetzt den frueheren REASON_MODULE_MAP-Lookup.
local function get_reason_module(why)
  if not why or why == "" then return nil end
  local entry = REASON_REGISTRY[why]
  if type(entry) == "table" then return entry.module end
  return nil
end
...
local function part_is_likely_attachment_vector(p)
  ...
  if ctype:find("application/pdf", 1, true) or
     ...
     ctype:find("text/javascript", 1, true) or
     ctype:find("application/x%-javascript", 1, false) or
     ctype:find("application/pkix%-cert", 1, false) or
     ctype:find("application/x%-x509%-ca%-cert", 1, false) then
    return true
  end
...
local function scan_js_smuggling_html_module(ctx, html_view)
  ...
  detect_advanced_api_calls(lc, function(why)
    local target_mod = get_reason_module(why) or mod
...
local function build_reason_summary(reasons)
  ...
  if reasons["atob"] or reasons["blob"] or reasons["createObjectURL"] or reasons["fetch"] or
     ...
     reasons["att_svg_smuggling_context"] or reasons["b64_joined_parts"] or reasons["virtual_b64_candidates"] then add_tag("[JS_SMUGGLING]") end
  if reasons["antisandbox_webdriver"] or reasons["hardware_check_evasion"] or reasons["human_interaction_required"] then add_tag("[EVASION]") end
  if reasons["geo_targeting_api"] or reasons["geo_location_api"] or reasons["timezone_targeting"] then add_tag("[GEO_TARGETING]") end
  if reasons["webcrypto_api"] or reasons["serviceworker_api"] or reasons["webworker"] or
     reasons["webassembly"] or reasons["qr_canvas_api"] then add_tag("[SUSPICIOUS_API]") end
  ...
  if reasons["clickfix_lure"] or reasons["fake_captcha_lure"] or
     ...
     reasons["powershell_lure"] then add_tag("[CLICKFIX]") end
  ...
  if reasons["cert_inline_pem"] or reasons["cert_inline_pkcs"] or reasons["cert_data_uri"] or
     reasons["cert_base64_block"] then add_tag("[CERT_SMUGGLING]") end
...
local function apply_markers(ctx)
  ...
  if reasons["split_payload"] or reasons["b64_joined_parts"] or reasons["virtual_b64_candidates"] then task:insert_result("HTML_SMUGGLING_MARKER_SPLIT_PAYLOAD", 1.0) end
  ...
  if reasons["clickfix_lure"] or reasons["fake_captcha_lure"] or
     reasons["clipboard_exec_lure"] or reasons["run_dialog_lure"] or
     reasons["powershell_lure"] then task:insert_result("HTML_SMUGGLING_MARKER_CLICKFIX", 1.0) end
  ...
  if reasons["att_pdf_javascript"] or reasons["att_pdf_openaction"] or reasons["att_pdf_launch"] or
     reasons["att_pdf_embeddedfile"] or reasons["att_pdf_richmedia"] then task:insert_result("HTML_SMUGGLING_MARKER_PDF_ACTIVE", 1.0) end
  if reasons["att_svg_script"] or reasons["att_svg_event_handler"] or reasons["att_svg_foreignobject"] or
     reasons["att_svg_xlink_href"] or reasons["att_svg_data_uri"] then task:insert_result("HTML_SMUGGLING_MARKER_SVG_ACTIVE", 1.0) end
  if reasons["cert_inline_pem"] or reasons["cert_inline_pkcs"] or reasons["cert_data_uri"] or
     reasons["cert_base64_block"] then task:insert_result("HTML_SMUGGLING_MARKER_CERT_SMUGGLING", 1.0) end
  ...
  -- NEU v4.4.1: Logging fuer ungemappte payload_kind / critical_kind Werte.
  -- Wenn sniff_decoded() einen neuen Typ zurueckgibt der nicht in critical_map steht,
  -- erscheint ein warnx im Log statt stillem Ignorieren.
  local critical_map = {
  ...
  if marker_kind then
    if critical_map[marker_kind] then
      task:insert_result(critical_map[marker_kind], 1.0)
    else
      rspamd_logger.warnx(task,
        "HTML_SMUGGLING || apply_markers: ungemappter kind=%s (critical_kind=%s payload_kind=%s)",
        tostring(marker_kind),
        tostring(ctx.critical_kind),
        tostring(ctx.payload_kind))
    end
  end
end
